<template>
  <section class="container pt-9 !pb-24 2xl:mb-5 relative">
    <FormHeader
      ...
      icon="Light"
      linkText="S Corp or C Corp"
      desc="Sole Proprietors are less likely to be approved for financing. An S Corp or C Corp is one alternative to a Sole Proprietor."
    />
    ...
    />
    <BaseResources
      text="Click a resource below to learn more and Form and S Corp or C Corp."
      :resources="resources"
    />

    <BaseBackNextBtns
      nextLabel="I Filed a Corp"
      :nextDisabled="false"
      @next="goNext"
    />
  </section>
...
// Methods
const goNext = () =>
  router.push("/fundability/foundation/business-entity/s-or-c");
</script>
